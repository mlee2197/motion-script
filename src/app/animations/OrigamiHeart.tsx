...
const OrigamiHeart = () => {
  ...
  const handleClick = () => {
    ...
    const duration = 1.5;
    tl.set([topTriangle, leftBox, rightBox, tlTriangle, trTriangle, bBoxContainer, bBox, brTriangle, blTriangle], {
      clearProps: true,
    });
  ...
  return (
    <div className="animation-container flex justify-center items-center">
      ...
      <div ref={ref} className="relative w-[150px] h-[150px] rotate-45">
        ...
        <div className="t-triangle absolute -top-1/2 -left-1/2 -translate-x-[13px] translate-y-[55.5px] border-[68px] border-transparent border-r-red-200 origin-right rotate-45"></div>
        ...
        <div className="b-box-container absolute bottom-[25px] -right-[0px] h-[50px] w-[50px] rotate-45 origin-left">
          <div className="b-box absolute bottom-0 -right-[10.5px] h-[50px] w-[50px] bg-red-200 rotate-45" />
        </div>
